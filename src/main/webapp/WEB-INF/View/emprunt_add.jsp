	        ...
	        <div class="row">
	          <div class="input-field col s6">
	            <select id="idLivre" name="idLivre" class="browser-default">
	              ...
	              <c:forEach var="current" items="${ListLivreDispo}">
                  <option value="${current.primaryKey}">"${current.titre}", ${current.auteur}</option>
                </c:forEach>
	            </select>
	          </div>
	          <div class="input-field col s6">
	            <select id="idMembre" name="idMembre" class="browser-default">
	              ...
	              <c:forEach var="current" items="${ListMembreEmpruntPossible}">
                  <option value="${current.primaryKey}">${current.prenom} ${current.nom}</option>
                </c:forEach>
	            </select>
	          </div>
	        </div>
