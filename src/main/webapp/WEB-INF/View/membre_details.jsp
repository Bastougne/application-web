...
<body>
  ...
  <main>
    <section class="content">
      ...
      <div class="row">
      <div class="container">
      <h5>Details du membre n.${current.primaryKey}</h5>
        <div class="row">
	      <form action="/TP3Ensta/membre_details?id=${current.primaryKey}" method="post" class="col s12">
	        <div class="row">
	          <div class="input-field col s4">
	            <input id="nom" type="text" value="${current.nom}" name="nom">
	        ...
	        <div class="row">
	          <div class="input-field col s12">
	            <input id="adresse" type="text" value="${current.adresse}" name="adresse">
	            <label for="adresse">Adresse</label>
	          </div>
	        </div>
	        <div class="row">
	          <div class="input-field col s6">
	            <input id="email" type="email" value="${current.email}" name="email">
	            <label for="email">E-mail</label>
	          </div>
	          <div class="input-field col s6">
	            <input id="telephone" type="tel" value="${current.telephone}" name="telephone">
	      ...
	      <form action="/TP3Ensta/membre_delete" method="get" class="col s12">
	        <input type="hidden" value="${current.primaryKey}" name="id">
	        <div class="row center">
